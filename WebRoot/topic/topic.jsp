 ...
 %>
	...
	<table width="1000" align="center" border="1" cellspacing="0">
		...
		<tr style="height:100px">
			<td>
			<!-- 得到用户信息 -->
			<s:a href="getAuthorInfo.action?authorID=%{#request.topic.userID}&&userName=%{#request.user.userName}&&pageNow=1&&userID=%{#request.userID}&&flag=0" ><s:property value="#request.user.userName" /></s:a>
			</td>
