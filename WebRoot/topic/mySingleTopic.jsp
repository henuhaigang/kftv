<%@ page language="java" import="java.util.*, com.forum.model.*" pageEncoding="UTF-8"%>
...
%>
	...
	<%
		/*  String name = (String) request.getAttribute("userName"); //.getParameter("userName");
	...
	<table width="1000" align="center" border="1" cellspacing="0">
		...
		<tr style="height:100px">
			<td><s:property value="#request.userName" />
			</td>
			<td><s:property value="#request.topic.title" />
			</td>

			<td><s:property value="#request.topic.content"
					escapeHtml="false" />&nbsp; &nbsp; &nbsp; &nbsp;</td>
		...
		<s:iterator value="#request.list" id="replyTopics">
			...
			<tr>
				...
				<td><s:property value="#replyTopics[0].content" escapeHtml="false" />
				</td>
	...
	<s:form action="replyTopic">
	 ...
	 <s:hidden name="userID"  value="%{#request.userID}"></s:hidden>
		...
		<s:submit id="submit" value="提交评论"></s:submit>
